...
import com.chcode.domain.vo.BlogUserLoginVo;
...
public class BlogLoginServiceImpl implements BlogLoginService {
    ...
    public ResponseResult login(User user) {
        ...
        Authentication authenticate = authenticationManager.authenticate(authenticationToken);  // 重写UserDetailsService，进行验证
        ...
        //获取userid 生成token
        LoginUser loginUser = (LoginUser)authenticate.getPrincipal(); // public UserDetails loadUserByUsername(String username)
